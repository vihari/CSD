...
class Logger():
    ...
    def get_name_from_args(args):
        ...
        name = "eps%d_bs%d_lr%g_class%d_jigClass%d" % (args.epochs, args.batch_size, args.learning_rate, args.n_classes,
        ...
        if hasattr(args, "classify_only_sane") and args.classify_only_sane:
